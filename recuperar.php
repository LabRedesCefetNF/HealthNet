...
header('Content-Disposition: attachment; filename=downloads/'.$arquivo->dado);
header('Expires: 0');
header('Cache-Control: must-revalidate');
header('Pragma: public');
header('Content-Length: ' . filesize('downloads/'.$arquivo->dado));
readfile('downloads/'.$arquivo->dado);
